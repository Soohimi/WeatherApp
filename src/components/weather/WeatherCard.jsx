...
function WeatherCard() {
  ...
  return (
    <div
      ...
      dir="ltr"
    >
      <div className="w-[calc(100%-2rem)] mt-[1.25rem] mb-8 rounded-2xl bg-gradient-to-br from-[#181818] to-[#1f1f1f] border border-[#333333] h-full mx-auto shadow-lg hover:shadow-xl transition-all duration-300">
        <TodayHighlights />
      </div>
    </div>
  );
